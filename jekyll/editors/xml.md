---
layout: page
title: "Guide to XML usage for HMT editors"
---

This guide

For a alphabetical list of all allowed TEI elements, see [this page](../tei-elements/).
...
: Our transcription does not  note ligatures or variant letter forms: readers interested in these visual features of the manuscript should consult the associated high-resolution images.  We treat regular abbreviated renderings of morphological endings, prepositions, the conjunction καί and the particle δέ as variant letter forms, and silently expand these in the transcriptions. See more on variant letter forms under abbreviations.
...
[2]: http://www.homermultitext.org/hmt-digital/images?request=GetIIPMooViewer&urn=urn:cite:hmt:vaimg.VA113RN_0285@0.1832,0.4222,0.0741,0.0233

[macron]: http://www.homermultitext.org/iipsrv?OBJ=IIP,1.0&FIF=/project/homer/pyramidal/VenA/VA113R_-0285.tif&RGN=0.1832,0.4222,0.0741,0.0233&WID=100&CVT=JPEG
